...
declare module '#imports' {
  ...
  export { GlassCard } from '../src/components/GlassCard';
  export { GlassInput } from '../src/components/GlassInput';
  export { ThemeProvider, useTheme } from '../src/components/ThemeProvider';
}
